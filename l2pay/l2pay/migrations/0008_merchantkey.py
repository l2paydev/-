...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('l2pay', '0007_alter_payments_created_at_alter_payments_updated_at'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='merchant_keys', to=settings.AUTH_USER_MODEL)),
            ],
            options={
